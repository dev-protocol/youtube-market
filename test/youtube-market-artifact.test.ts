...
import MockMarketArtifact from '../artifacts/contracts/test/MockMarket.sol/MockMarket.json'
import MockMetricsArtifact from '../artifacts/contracts/test/MockMetrics.sol/MockMetrics.json'
...
describe("YoutubeMarket", () => {
  ...
  beforeEach(async () => {
    marketBehavior = await deployContract(wallet, YoutubeMarketArtifact);
  });

  before(async () => {
    market = await deployContract(wallet, MockMarketArtifact);
    metrics = await deployContract(wallet, MockMetricsArtifact);
